...
function byvex_enqueue_scripts()
{
	...
	// Style CSS
	wp_enqueue_style('byvex-style', get_stylesheet_uri(), array('bootstrap'), filemtime(get_template_directory() . "/style.css"));

	// Google Font - Rubik
	wp_enqueue_style('rubik', 'https://fonts.googleapis.com/css2?family=Rubik:wght@400;500;600;700&display=swap', array('bootstrap'));
